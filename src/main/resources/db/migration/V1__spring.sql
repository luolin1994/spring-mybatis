...
insert into login_user values(1, 'admin', '$2a$10$qxW.4rU1BoA29DCQnQ2Wkul3uniMQWolP/.q2BQRwu6brlK6M.uF6'),
                              (2, 'user', '$2a$10$qxW.4rU1BoA29DCQnQ2Wkul3uniMQWolP/.q2BQRwu6brlK6M.uF6');
...
---用户-角色表
-----------------------------
DROP TABLE IF EXISTS `loginuser_role`;
...
insert into loginuser_role values(1,1,1), (2,1,2), (3,2,2);

---------------------------
----权限表
--------------------------
DROP TABLE IF EXISTS `peimission`;
 create table `permission`(
         `id` int(11) not null anto_increment,
...
-----权限-角色
-----------------------------
DROP TABLE IF EXISTS `permission-role`
